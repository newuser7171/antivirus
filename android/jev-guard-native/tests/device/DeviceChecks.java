...
public class DeviceChecks extends Instrumentation {
 ...
 @Override public void onStart(){Bundle b=new Bundle();try{
  ...
  b.putString("stream","PASS: device APK parse, SHA-256, signing identity, permissions, encrypted key roundtrip/removal, invalid APK rejection, report persistence, and four screens\n");finish(Activity.RESULT_OK,b);
