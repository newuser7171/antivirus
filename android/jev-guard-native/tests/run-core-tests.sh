...
java com.sun.tools.javac.Main -cp build/json-20240303.jar -d build/tests app/src/main/java/ai/jevguard/Api.java app/src/main/java/ai/jevguard/RiskRules.java tests/CoreTests.java
